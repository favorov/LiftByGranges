#' Liftover whole genome strand-separated BigWigs to an exome BigWig
#' 
...
liftOverToExomeBigWig<-function(input_bw, chain, output_bw, write_chr = TRUE, out_chr){
  ...
  # Perform liftOver for + and - strands given an exome chain object; reduce to only relevant intervals
  # and combine into one bw
